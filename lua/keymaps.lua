...
vim.api.nvim_set_keymap('n', '<leader>ts', ':set scrolloff=0<CR>',
    { noremap = true })
vim.api.nvim_set_keymap('n', '<leader>tS', ':set scrolloff=999<CR>',
    { noremap = true })
...
vim.api.nvim_set_keymap('n', '<S-Tab>', ':bprevious<CR>',
    { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-x>', ':bdelete<CR>',
    { noremap = true, silent = true })
...
vim.keymap.set('n', 'gX', vim.diagnostic.goto_prev,
    { desc = 'Go to previous diagnostic message' })

vim.keymap.set('n', 'gx', vim.diagnostic.goto_next,
