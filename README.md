...
### this is the one which is actively being used and begin updated 
...
- on Windows (cmd)
```
git clone https://github.com/samarth-nagar/modular-nvim %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/samarth-nagar/modular-nvim $env:USERPROFILE\AppData\Local\nvim\ 
```
